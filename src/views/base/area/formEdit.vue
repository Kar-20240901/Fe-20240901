...
import { IAreaDialogTreeFormProps } from "@/views/base/area/types";

const form = ref<BaseAreaInsertOrUpdateDTO>({});
const formRef = ref();
...
function addOpen(formTemp?: BaseAreaInsertOrUpdateDTO) {
  doOpen(
    formRef,
    form,
    visible,
...
const props = defineProps<IAreaDialogTreeFormProps>();
