...
import { BasePostInsertOrUpdateDTO } from "@/api/http/base/BasePostController";
import { R } from "@/model/vo/R";
import { formEditRule } from "@/views/base/post/formEditRule";
...
function addOpen(formTemp?: BasePostInsertOrUpdateDTO) {
  doOpen(
    formRef,
    form,
    visible,
...
const props = defineProps<IPostDialogTreeFormProps>();
