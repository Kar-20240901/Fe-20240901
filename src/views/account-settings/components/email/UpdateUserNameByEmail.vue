...
import {
  signEmailUpdateUserName,
  SignEmailUpdateUserNameDTO,
  signEmailUpdateUserNameSendCode
...
const form = ref<SignEmailUpdateUserNameDTO>({});
const formRef = ref();
...
function confirmFun() {
  return signEmailUpdateUserName(form.value);
}
          ...
          >
            <div class="w-full flex justify-between">
              ...
              <el-button
                ...
                class="ml-2"
                @click="
                  useVerifyCode().start(formRef, 'username', () => {
                    return signEmailUpdateUserNameSendCode({
